21,51,22,53,23,54,24],2023:[55,26,54,25,55,26,56,27,58,28,59,29],2024:[0,31,0,31,1,32,2,33,4,34,5,35],2025:[6,37,5,36,6,37,7,38,9,39,10,40],2026:[11,42,10,41,11,42,12,43,14,44,15,45],2027:[16,47,15,46,16,47,17,48,19,49,20,50],2028:[21,52,21,52,22,53,23,54,25,55,26,56],2029:[27,58,26,57,27,58,28,59,30,60,31,1],2030:[32,3,31,2,32,3,33,4,35,5,36,6]};
...
const TIME_ACCENT={
  asa:{c1:"#d98a5f",c2:"#f0b896",text:"#3a2010"},
  hiru:{c1:"#2f9d8f",c2:"#7ecfc2",text:"#0f2e28"},
  yugata:{c1:"#c97a9a",c2:"#f0b8c4",text:"#3a1a26"},
  yoru:{c1:"#3a4a8a",c2:"#7a8ac0",text:"#ffffff"},
};
const TIME_LOGOS={
  asa:"/images/logo-asa.jpg",
  hiru:"/images/logo-hiru.jpg",
  yugata:"/images/logo-yugata.jpg",
  yoru:"/images/logo-yoru.jpg",
};
const TIME_BG_IMAGES={
  asa:"/images/bg-asa.jpg",
  hiru:"/images/bg-hiru.jpg",
  yugata:"/images/bg-yugata.jpg",
  yoru:"/images/bg-yoru.jpg",
};
const HOME_HEADER_IMG="/images/home-header.jpg";

const TIME_GRADIENTS={
  asa:"linear-gradient(160deg,#fdece1,#faf6ee 45%,#e7f0e6)",
  hiru:"linear-gradient(160deg,#e6f3f2,#eef7f5 45%,#cfe8e4)",
  yugata:"linear-gradient(160deg,#fbe6e1,#f7ddce 45%,#f0d2be)",
  yoru:"linear-gradient(160deg,#e9e3f1,#dbd4ea 45%,#c7bfdc)"
};
function getTimeMood(){
  const h=new Date().getHours();
  if(h>=5&&h<10)return"asa";
  if(h>=10&&h<17)return"hiru";
  if(h>=17&&h<19)return"yugata";
  return"yoru";
}
...
function InputForm({onSubmit,buttonLabel,accent}){
  const acc=accent||{c1:"#c8a030",c2:"#e0c060",text:"#2a2010"};
    ...
    <div style={card}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"20px",marginBottom:"16px"}}>
        <div style={{textAlign:"center"}}>
          ...
          <div style={{fontSize:"14px",fontWeight:"600",color:C.text}}>{typeA}</div>
        ...
        <div style={{textAlign:"center"}}>
          ...
          <div style={{fontSize:"14px",fontWeight:"600",color:C.text}}>{typeB}</div>
      ...
      <div style={{textAlign:"center"}}>
        ...
        <div style={{fontSize:"clamp(18px,4vw,24px)",fontWeight:"600",color:C.gold,marginBottom:"4px"}}>{relation.name}</div>
        <div style={{fontSize:"12px",color:C.muted,marginBottom:"12px"}}>{relation.desc}</div>
        <div style={{padding:"8px 14px",background:sameTeam?"rgba(201,168,76,0.1)":"rgba(42,122,106,0.08)",border:`1px solid ${sameTeam?C.borderGold:C.teal}`,borderRadius:"18px",fontSize:"11px",color:sameTeam?C.accent:C.teal}}>
...
function AishoResult({resultA,resultB,aisho}){
  ...
  return(<div>
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"12px",marginBottom:"8px"}}>
      {[resultA,resultB].map((r,i)=><div key={i} style={{textAlign:"center",padding:"20px 12px",background:`linear-gradient(160deg,#f5edd8,#fdf8f0)`,borderRadius:"18px",border:`1px solid ${C.borderGold}`}}><div style={{fontSize:"9px",color:C.muted,letterSpacing:"0.3em",marginBottom:"8px"}}>{i===0?"あなた":"お相手"}</div><div style={{fontSize:"clamp(14px,3vw,18px)",fontWeight:"600",color:"#2a2010",marginBottom:"6px"}}>{r.name}</div><div style={{fontSize:"11px",color:C.muted}}>{r.year}/{r.month}/{r.day}</div><div style={{fontSize:"12px",color:C.teal,fontWeight:"400",marginTop:"6px"}}>{r.honshitsu}</div></div>)}
    </div>
    <div style={{textAlign:"center",fontSize:"28px",margin:"16px 0"}}>{aisho.isFutatgo?"✨":"💫"}</div>
    <SectionTitle>✦ 魂の相性</SectionTitle>
    <div style={{...card,textAlign:"center"}}><div style={{fontSize:"10px",color:C.muted,marginBottom:"8px"}}>魂の相性</div><div style={{fontSize:"clamp(22px,6vw,34px)",fontWeight:"600",color:C.gold}}>{aisho.sogoLabel}</div></div>
    <SectionTitle>✦ 過去生の関係</SectionTitle>
    <div style={{...card,textAlign:"center"}}><div style={{fontSize:"10px",color:C.muted,marginBottom:"8px"}}>過去生の関係</div><div style={{fontSize:"clamp(22px,6vw,34px)",fontWeight:"600",color:C.purple}}>{aisho.kakoLabel}</div>{aisho.kakoLabel!=="初"&&<div style={{fontSize:"12px",color:C.muted,marginTop:"8px"}}>前世からの深い縁があります</div>}</div>
    ...
    {[resultA,resultB].map((r,i)=><div key={i} style={{...card,marginBottom:"12px"}}><div style={{fontSize:"11px",color:C.gold,letterSpacing:"0.2em",marginBottom:"12px",fontWeight:"400"}}>{i===0?"▶ あなた":"▶ お相手"}　{r.name}</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"10px"}}><div style={{background:"#f5edd8",borderRadius:"18px",padding:"12px"}}><div style={{fontSize:"9px",color:C.muted,marginBottom:"4px"}}>魂の力</div><div style={{fontSize:"13px",fontWeight:"400",color:C.accent}}>{r.honshitsu}</div></div><div style={{background:"#f5edd8",borderRadius:"18px",padding:"12px"}}><div style={{fontSize:"9px",color:C.muted,marginBottom:"4px"}}>魂の成長テーマ</div><div style={{fontSize:"13px",fontWeight:"400",color:C.teal}}>{r.konjoKadai}</div></div><div style={{background:"#f5edd8",borderRadius:"18px",padding:"12px"}}><div style={{fontSize:"9px",color:C.muted,marginBottom:"4px"}}>コミュニケーション</div><div style={{fontSize:"13px",fontWeight:"400"}}>{ANIMAL_EMOJI[r.dobutsu]||"✨"} {r.dobutsu}</div></div><div style={{background:"#f5edd8",borderRadius:"18px",padding:"12px"}}><div style={{fontSize:"9px",color:C.muted,marginBottom:"4px"}}>タイプ</div><div style={{fontSize:"13px",fontWeight:"400",color:C.muted}}>{r.typeLabel}</div></div></div></div>)}
  </div>);
}
...
function CommAishoTab({C}){
  ...
  return(
    <div style={{padding:"20px",maxWidth:"600px",margin:"0 auto"}}>
      ...
      {rel&&(
        <div style={{marginTop:"24px",padding:"20px",borderRadius:"18px",background:`linear-gradient(135deg,${rel.color||"#C9A84C"}22,${rel.color||"#C9A84C"}44)`,border:`1.5px solid ${rel.color||"#C9A84C"}`,textAlign:"center"}}>
...
export default function App(){
  ...
  const isMobile=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)||window.innerWidth<=430;
  const tabColors={"kojin":["#c8a030","#e0c060","#2a2010"],"aisho":["#c8a030","#e0c060","#2a2010"],"comm_aisho":["#c8a030","#e0c060","#2a2010"]};
  const tabStyle=(tab)=>{const acc=TIME_ACCENT[timeMood];return{flex:1,padding:"14px 8px",background:"transparent",border:"none",borderBottom:activeTab===tab?`3px solid ${acc.c1}`:`1px solid ${C.borderGold}`,color:activeTab===tab?acc.c1:C.muted,fontSize:"11px",letterSpacing:"0.2em",cursor:"pointer",fontFamily:"inherit",fontWeight:activeTab===tab?"700":"600"};};
  return(<><style>{`
  @media print {
    ...
    * { 
    ...
    .is-mobile .print-header {
      max-height: 15mm !important;
      overflow: hidden !important;
    }
  }
`}</style><div className={`app-bg${isMobile?" is-mobile":""}`} style={{minHeight:"100vh",backgroundImage:`url(${TIME_BG_IMAGES[timeMood]})`,backgroundSize:"100% auto",backgroundRepeat:"repeat-y",backgroundPosition:"center",transition:"background-image 1.2s ease",color:C.text,fontFamily:"'Georgia','Yu Mincho','Noto Serif JP',serif",fontWeight:"400"}}>
    {showHome?(
      <div style={{position:"relative",maxWidth:"460px",margin:"0 auto",padding:"0 0 60px"}}>
        ...
        {[
          ...
          {tab:"aisho",title:"相性診断",desc:"ふたりの相性を見る"},
          {tab:"comm_aisho",title:"コミュ相性",desc:"コミュニケーションタイプの相性"},
        ].map((item)=>(
          <button key={item.tab} onClick={()=>{setActiveTab(item.tab);setShowHome(false);}} style={{width:"100%",textAlign:"left",display:"flex",alignItems:"center",gap:"14px",background:"linear-gradient(135deg,#ffffff,#fdf8f0)",border:`1px solid ${C.borderGold}`,borderRadius:"18px",padding:"20px 18px",marginBottom:"18px",boxShadow:"0 10px 28px rgba(200,160,48,0.12)",cursor:"pointer",fontFamily:"inherit"}}>
            <div style={{width:"3px",alignSelf:"stretch",background:TIME_ACCENT[timeMood].c1,borderRadius:"2px",flexShrink:0}}/>
            <div style={{flex:1}}>
              <div style={{fontSize:"17px",fontWeight:"600",color:"#8a6010",marginBottom:"6px",fontFamily:"'Georgia','Yu Mincho','Noto Serif JP',serif"}}>{item.title}</div>
              <div style={{fontSize:"12px",color:C.muted}}>{item.desc}</div>
            </div>
            <span style={{fontSize:"18px",color:TIME_ACCENT[timeMood].c1,flexShrink:0}}>›</span>
          </button>
        ))}
        </div>
      </div>
