...
export default function App(){
  ...
  return(<><style>{`@media print{.no-print{display:none!important;}button{display:none!important;}.tab-bar{display:none!important;}}`}</style><div style={{minHeight:"100vh",background:`linear-gradient(160deg,#faf6ee,#f5edd8,#faf6ee)`,color:C.text,fontFamily:"'Georgia','Yu Mincho','Noto Serif JP',serif"}}>
